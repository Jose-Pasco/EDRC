...
imgIlu=cv2.imread('img/img_b_ilu_c/15_c.jpg')
...
plt.subplot(2,2,1)
plt.title('Sin iluminación')
plt.imshow(cv2.imread('img/img_p_n/15.jpg')) 

plt.subplot(2,2,2)
plt.title('Sin iluminación KP')
plt.imshow(n)

plt.subplot(2,2,3)
plt.title('Con iluminación')
plt.imshow(cv2.imread('img/img_b_ilu_c/15_c.jpg')) 

plt.subplot(2,2,4)
plt.title('Con iluminación KP')
...
#k.to_excel(r'E:/2020_1/Metodologia de la investigacion/Datos/export_datafra,e.xlsx',index=True,header=True)
